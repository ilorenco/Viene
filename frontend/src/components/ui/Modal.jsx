    ...
    return (
        <DialogPrimitive.Portal>
            ...
            <DialogPrimitive.Content
                className={cn(
                    'bg-background data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out fixed top-1/2 left-1/2 z-[2000] flex max-h-[85vh] w-[90vw] max-w-md -translate-x-1/2 -translate-y-1/2 flex-col gap-4 overflow-y-auto rounded-3xl p-6 shadow-xl',
                    className,
                )}
                {...props}
            >

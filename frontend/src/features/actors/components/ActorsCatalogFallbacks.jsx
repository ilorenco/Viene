// Estado de carregamento do catálogo de atores: placeholder da PÁGINA inteira
// (banner + barra de filtros + grade), mostrado pelo <Suspense> enquanto os atores
// carregam. Mantém o mesmo formato do banner para a tela não "pular" quando os
// dados chegam. O ERRO não tem fallback por página — é tratado de forma central no
// MainLayout (componente RouteError), como nas telas do colega.

import { ActorListSkeleton } from '@/features/actors/components/ActorList'

export function ActorsCatalogSkeleton() {
    return (
        <>
            ...
            <div className="flex animate-pulse gap-2">
                ...
                <div className="bg-secondary/10 ml-auto h-9 w-32 rounded-full" />
            </div>
